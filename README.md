...
2) dnf -y install https://github.com/UnitedRPMs/unitedrpms/releases/download/5/unitedrpms-$(rpm -E %fedora)-5.fc$(rpm -E %fedora).noarch.rpm
```
...
```
# rpm -K https://github.com/UnitedRPMs/unitedrpms/releases/download/5/unitedrpms-$(rpm -E %fedora)-5.fc$(rpm -E %fedora).noarch.rpm
```
